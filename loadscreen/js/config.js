...
{    
    ...
    */
    loadingMessages:
    [
        "スターリーク | Witaj na serwerze Star Leaks!",
        "スターリーク | Znajdziesz tutaj najnowsze i najrzadsze skrypty.",
        "スターリーク | Leakujemy najlepsze skrypty i interiory.",
        "スターリーク | Discord - discord.gg/Pxpm8aCM",
        "スターリーク | - j. Japońskim oznacza Star Leaks",
		"スターリーク | Na naszym discordzie znajduje się ponad 2000 osób."
    ],
